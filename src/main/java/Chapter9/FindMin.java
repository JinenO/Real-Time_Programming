...
public class FindMin extends RecursiveTask<Integer> {
    ...
    protected Integer compute() {
        ...
        if(sliceLength>2){
            ...
            lowerHalf.fork();//enable concurrent

            //compute second subtask directly to improve efficiency
            int upperResult= upperHalf.compute();

            //Join first subtask
            int lowerResult= lowerHalf.join();//wait for the lowerhalf
            //result task to complete & return result
    ...
    public static void main (String[] args) {
        ...
        //Display array content (it is just optional)
